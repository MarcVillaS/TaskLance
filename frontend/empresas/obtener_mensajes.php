...
foreach ($mensajes as $msg) {
    ...
    if (!empty($msg['file_path'])) {
        ...
        $icon = "&#128206;";
        echo '<br><a href="/tasklancenuevo/frontend/' . htmlspecialchars($msg['file_path']) . '" target="_blank" style="display:inline-block;margin-top:4px;font-size:1.09em;color:#007bff;text-decoration:underline;">' . $icon . ' ' . htmlspecialchars($file_name) . '</a>';
    }
